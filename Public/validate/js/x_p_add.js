function checkqpxm(qpid) {
    ...
    if (name == null || name == "") {
        document.getElementById('qpxmnull' + qpid).innerHTML = "房屋性质不能为空"
        return false;
    } else {
...
function checkqpgx(qpid) {
    ...
    if (name == null || name == "") {
        document.getElementById('qpgxnull' + qpid).innerHTML = "房屋位置不能为空"
        return false;
    } else {
...
function checkqplxfs(qpid) {
    ...
    if (name == null || name == "") {
        document.getElementById('qplxfsnull' + qpid).innerHTML = "房屋价值不能为空"
        return false;
    } else if (name.match(/^(-)?(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/) == null) {
        document.getElementById('qplxfsnull' + qpid).innerHTML = "房屋价值不正确";
        return false;
    } else {
...
function checkname() {
    var name = $('input[name = x_p_name]').val();
    if (name == null || name == "") {
...
function checkidcard() {
    var name = $('input[name = x_p_idcard]').val();
    if (name == null || name == "") {
...
function checkmz() {
    var name = $('input[name = x_p_mz]').val();
    if (name == null || name == "") {
        mz.innerHTML = "民族不能为空!";
        return false;
...
function checkjkzk() {
    var name = $('input[name = x_p_jkzk]').val();
    if (name == null || name == "") {
...
function checkgzdw() {
    var name = $('input[name = x_p_gzdw]').val();
    if (name == null || name == "") {
...
function checkzw() {
    var name = $('input[name = x_p_zw]').val();
    if (name == null || name == "") {
        zw.innerHTML = "职务不能为空!";
        return false;
    } else {
...
function checkhkzz() {
    var name = $('input[name = x_p_hkzz]').val();
    if (name == null || name == "") {
...
function checksfzzz() {
    var name = $('input[name = x_p_sfzzz]').val();
    if (name == null || name == "") {
...
function checksjzz() {
    var name = $('input[name = x_p_sjzz]').val();
    if (name == null || name == "") {
...
function checklxfs() {
    var name = $('input[name = x_p_lxfs]').val();
    if (name == null || name == "") {
...
function checkpoxm() {
    var name = $('input[name = x_p_poxm]').val();
    if (name == null || name == "") {
...
function checkposfzh() {
    var name = $('input[name = x_p_posfzh]').val();
    if (name == null || name == "") {
...
function checkpolxfs() {
    var name = $('input[name = x_p_polxfs]').val();
    if (name == null || name == "") {
...
function checkposr() {
    var name = $('input[name = x_p_posr]').val();
    if (name == null || name == "") {
...
function checkpogzqk() {
    var name = $('input[name = x_p_pogzqk]').val();
    if (name == null || name == "") {
...
function checkpozw() {
    var name = $('input[name = x_p_pozw]').val();
    if (name == null || name == "") {
...
//function checkmxzc() {
//    var name = $('input[name = x_p_mxzc]').val();
//    if (name == null || name == "") {
...
function checkyhck() {
    var name = $('input[name = x_p_yhck]').val();
    if (name == null || name == "") {
...
//function checkfwxz() {
//    var name = $('input[name = x_p_fwxz]').val();
//    if (name == null || name == "") {
...
//function checkfwwz() {
//    var name = $('input[name = x_p_fwwz]').val();
//    if (name == null || name == "") {
//        fwwz.innerHTML = "房屋位置不能为空!";
//        return false;
//    } else {
//        fwwz.innerHTML = "";
//        return true;
...
//function checkfwjz() {
//    var name = $('input[name = x_p_fwjz]').val();
//    if (name == null || name == "") {
//        fwjz.innerHTML = "房屋价值不能为空!";
//        return false;
//    } else if (name.match(/^(-)?(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/) == null) {
//        fwjz.innerHTML = "房屋价值填写不正确，";
//        return false;
//    } else {
//        fwjz.innerHTML = "";
//        return true;
...
//    var name = $('input[name = x_p_clxhjz]').val();
//    if (name == null || name == "") {
...
//    var name = $('input[name = x_p_jtqtsr]').val();
//    if (name == null || name == "") {
...
//    var name = $('input[name = x_p_jtqtsrbz]').val();
//    if (name == null || name == "") {
...
//function checkxyked() {
//    var name = $('input[name = x_p_xyked]').val();
//    if (name == null || name == "") {
...
//
//function checkxykfz() {
//    var name = $('input[name = x_p_xykfz]').val();
//    if (name == null || name == "") {
...
//    var name = $('input[name = x_p_yhajdk]').val();
//    if (name == null || name == "") {
...
//
//function checkmjjd() {
//    var name = $('input[name = x_p_mjjd]').val();
//    if (name == null || name == "") {
...
//    var name = $('input[name = x_p_dwdbqk]').val();
//    if (name == null || name == "") {
...
//    var name = $('input[name = x_p_jtzhnsr]').val();
//    if (name == null || name == "") {
...
function checkdata() {
    ...
    if (checkname() == false)
        return false;
    else if (checkidcard() == false)
        return false;
    else if (checkmz() == false)
        return false;
    else if (checkjkzk() == false)
        return false;
    else if (checkgzdw() == false)
        return false;
    else if (checkzw() == false)
        return false;
    else if (checkhkzz() == false)
        return false;
    else if (checksfzzz() == false)
        return false;
    else if (checksjzz() == false)
        return false;
    else if (checklxfs() == false)
        return false;
    else if ($('input[name = x_p_hyzk]:checked').val() == 0) {
        if (checkpoxm() == false)
            return false;
        else if (checkposfzh() == false)
            return false;
        else if (checkpolxfs() == false)
            return false;
        else if (checkposr() == false)
            return false;
        else if (checkpogzqk() == false)
            return false;
        else if (checkpozw() == false)
            return false;
        else if (checkyhck() == false)
            return false;
        //else if (checkclxhjz() == false)
        //    return false;
        //else if (checkjtqtsr() == false)
        //    return false;
        //else if (checkxyked() == false)
        //    return false;
        //else if (checkxykfz() == false)
        //    return false;
        //else if (checkyhajdk() == false)
        //    return false;
        //else if (checkmjjd() == false)
        //    return false;
        //else if (checkdwdbqk() == false)
        //    return false;
        else
            return true;
    }
